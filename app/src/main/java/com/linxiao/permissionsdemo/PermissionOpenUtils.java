 ...
 * Description
 * Author lizheng
 * Create Data  2018\6\5 0005
 */
public class PermissionOpenUtils {

    private final String TAG = "PermissionPageManager";
    private Activity mContext;
    //自己的项目包名
    private String packageName="com.synative.zepra";
    private final int REQUEST_INFO_PERMS = 777;

    public PermissionOpenUtils(Activity context) {
    ...
    private void goLGMainager(){
        try {
            ...
            mContext.startActivityForResult(intent, REQUEST_INFO_PERMS);
        } catch (Exception e) {
